...
public class ExportExcelAspect {
    ...
    public Object handleExport(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (result instanceof List<?> dataList) {
            ...
            // 调用工具类生成Excel
            ExportExcelUtil.export(response, dataList, exportExcel.fileName(), clazz,exportExcel.sameValueMergeColumns(),exportExcel.enableTotal(),exportExcel.totalMergeColumnStart(),exportExcel.totalMergeColumnEnd(),exportExcel.totalText());
        }
